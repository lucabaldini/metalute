...
class MusicManAxis:
    ...
    def draw(self, offset):
        ...
        c3.draw(offset)
        arc3 = CircularArc(c3, r3, phi - 90., phi - 90. + phi3)
        arc3.draw(offset)
        p3 = arc3.end_point('p3')
        p3.draw(offset)
        c4 = p3.move(r4, arc3.phi2, 'c4')
        arc4 = CircularArc(c4, r4, arc3.phi2 - phi4 + 180., arc3.phi2 + 180.)
        arc4.draw(offset)
        p4 = arc4.start_point('p4')
        p4.draw(offset)
        c5 = p4.move(r5, arc4.phi1 + 180., 'c5')
        arc5 = CircularArc(c5, r5, arc4.phi1 - phi5, arc4.phi1)
        arc5.draw(offset)
        p5 = arc5.start_point('p5')
        p5.draw(offset)
        c6 = p5.move(r6, arc5.phi1, 'c6')
        arc6 = CircularArc(c6, r6, arc5.phi1 + 180., arc5.phi1 + phi6 + 180.)
        arc6.draw(offset)
        p7 = arc6.end_point('p7')
        p7.draw(offset)
        c7 = p7.move(r7, arc6.phi2, 'c7')
        arc7 = CircularArc(c7, r7, arc6.phi2 + 180. - phi7, arc6.phi2 + 180.)
        arc7.draw(offset)
        p8 = arc7.start_point('p8')
        p8.draw(offset)
        c8 = p8.move(r8, arc7.phi1 + 180., 'c8')
        arc8 = CircularArc(c8, r8, arc7.phi1 - phi8, arc7.phi1)
        arc8.draw(offset)
        p9 = arc8.start_point('p9')
        p9.draw(offset)
        c9 = p9.move(r9, arc8.phi1, 'c9')
        arc9 = CircularArc(c9, r9, arc8.phi1 + 180, arc8.phi1 + 180. + phi9)
        arc9.draw(offset)
        p10 = arc9.end_point('p10')
        p10.draw(offset)
        c10 = p10.move(r10, arc9.phi2, 'c10')
        arc10 = CircularArc(c10, r10, arc9.phi2 - 180. - phi10, arc9.phi2 - 180.)
        arc10.draw(offset)
        p11 = arc10.start_point('p11')
        p11.draw(offset)
        c11 = p11.move(r11, arc10.phi1 + 180., 'c11')
        arc11 = CircularArc(c11, r11, arc10.phi1 - phi11, arc10.phi1)
        arc11.draw(offset)
        p12 = arc11.start_point('p12')
        p12.draw(offset)
        c12 = p12.move(r12, arc11.phi1, 'c12')
        arc12 = CircularArc(c12, r12, arc11.phi1 + 180., arc11.phi1 + 180 + phi12)
        arc12.draw(offset)
        p13 = arc12.end_point('p13')
        p13.draw(offset)
        c13 = p13.move(r13, arc12.phi2, 'c13')
        arc13 = CircularArc(c13, r13, arc12.phi2 + 180. - phi13, arc12.phi2 + 180.)
        arc13.draw(offset)
